                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col align-self-center data " style="margin-right:5px ;">
                            ...
                            <div class="row justify-content-between mt-2 pe-2"><a href="#"
                                        ...
                                        href="#exampleModalToggle" role="button">Подано 6 заявок</a>
                            </div>
                            <div class="card-body">
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row mb-4" style="border-radius: 40px; background-color: rgba(0, 219, 194, 0.15)">
                    ...
                    <div class="col-2 align-self-center text-center">
                        <button class="p-2"
                                style="background-color:#D43B3B; border-radius:100px;color: #F5F5F2; border:0px   "><img
                                    src="../img/x.png" height="20px" width="20px">Отклонить
                        </button>
                    </div>
                </div>
                <div class="row mb-4" style="border-radius: 40px; background-color: rgba(0, 219, 194, 0.15)">
                ...
                <div class="row mb-4" style="border-radius: 40px; background-color: rgba(0, 219, 194, 0.15)">
                    ...
                    <div class="col-2 align-self-center text-center">
                        <button class="p-2"
                                style="background-color:#00DBC2; border-radius:100px;color: #F5F5F2; border:0px "><img
                                    src="../img/check.png" height="20px" width="20px">Одобрен
                        </button>
                    </div>
                </div>
                <div class="row mb-4" style="border-radius: 40px; background-color: rgba(0, 219, 194, 0.15)">
                ...
                <div class="row mb-4" style="border-radius: 40px; background-color: rgba(0, 219, 194, 0.15)">
                    ...
                    <div class="col-1 align-self-center text-end">
                        <button class="p-2"
                                style="background-color:#00DBC2; border-radius:100%;color: #F5F5F2; border:0px "><img
                                    src="../img/check.png" height="20px" width="20px"></button>
                    </div>
                    <div class="col-1 align-self-center text-start">
                        <button class="p-2"
                                style="background-color:#D43B3B; border-radius:100%;color: #F5F5F2; border:0px"><img
            ...
            <div class="modal-footer">
                <button class="p-2" style="background-color:#00DBC2; border-radius:100px;color: #F5F5F2; border:0px "
                        data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal">Сохранить
                    изменения
                </button>
            </div>
        </div>
