    ...
    <div class="row">
        <div class="col row">
            ...
            <div class="col-7 align-self-center">
                <p class="name mb-0"><?= $_COOKIE['name'] ?> <?= $_COOKIE['lastName'] ?><a href="?logout=yes"
                                                                                           style="text-decoration: none;margin-left: 10px; ">
                        <img src="../img/log-out.png" alt=""></a></p>
                    ...
                    <div class="card p-3">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-5 align-self-center" style="padding-left: 0px;">
                                <img src="https://pow.thevladoss.site/img/Rectangle 339.png" class="img-fluid cardimg"
                                     alt="...">
                            </div>
                            <div class="col align-self-start data " style="margin-right:5px ;">
                                <div class="row justify-content-start  mt-2"><a href="" class="col-5 text-center tag ">#спорт</a>
                                </div>
                                <div class="card-body">
                                    ...
                                    <p class="mb-0 points"><b>Обязанности: </b><?= $event->description ?></p>
                                    <?php
                                    if ($event->state == 'pending') {
                                        ?>
                                        <p class="mt-2 text-center mx-auto err w-75 pt-1 pb-1"
                                           style="background-color: #908D95"><img src="../img/loader.png" height="16px"
                                                                                  width="16px" alt=""
                                                                                  style="margin-right:5px">проходит
                                            проверку</p>
                                    <?php } elseif ($event->state == 'denied') { ?>
                                        <p class="mt-2 text-center mx-auto err w-75 pt-1 pb-1"
                                           style="background-color:#D43B3B "><img src="../img/x-circle.png"
                                                                                  height="16px" width="16px" alt=""
                                                                                  style="margin-right:5px">в участии
                                            отказано</p>
                                    <?php } else { ?>
                                        <p class="mt-2 text-center mx-auto err w-75 pt-1 pb-1"
                                           style="background-color:#00dbc2 "><img src="../img/check-square.png"
                                                                                  height="16px" width="16px" alt=""
                                                                                  style="margin-right:5px">вы участвуете
                                        </p>
                                    <?php } ?>
                                </div>
                            </div>
